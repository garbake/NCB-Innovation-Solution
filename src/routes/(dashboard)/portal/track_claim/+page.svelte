<div class="mx-auto max-w-lg text-center">
    ...
    <p class="text-gray-500 sm:mt-2 sm:block">
        Discover current stage of your claim .
    </p>
</div>
        ...
        >
            ...
            >
                <li class="flex items-center gap-2 bg-white p-2">
                    <span
                        class="h-6 w-6 rounded-full bg-blue-600 text-center text-[10px]/6 font-bold text-white"
                    >
                        1
                    </span>

                    <span class="sm:block"> Application </span>
                </li>
                ...
                <li class="flex items-center gap-2 bg-white p-2">
                    ...
                    <span class="sm:block"> Analyzing </span>
                </li>
                ...
                <li class="flex items-center gap-2 bg-white p-2">
                    ...
                    <span class="sm:block"> Approval </span>
                </li>
            </ol>
        </div>
